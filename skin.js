...
// Generated Tue Aug 22 16:01:21 2017
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._cardboard=document.createElement('div');
		this._cardboard__img=document.createElement('img');
		this._cardboard__img.className='ggskin ggskin_svg';
		this._cardboard__img.setAttribute('src',basePath + 'images/cardboard.svg');
		this._cardboard__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
		this._cardboard__img['ondragstart']=function() { return false; };
		this._cardboard.appendChild(this._cardboard__img);
		this._cardboard.ggId="cardboard";
		this._cardboard.ggTop=-45;
		this._cardboard.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._cardboard.ggVisible=true;
		this._cardboard.className='ggskin ggskin_svg ';
		this._cardboard.ggType='svg';
		hs ='';
		hs+='cursor : pointer;';
		hs+='height : 32px;';
		hs+='left : 10px;';
		...
		hs+='width : 32px;';
		hs+='pointer-events:auto;';
		this._cardboard.setAttribute('style',hs);
		this._cardboard.style[domTransform + 'Origin']='50% 50%';
		me._cardboard.ggIsActive=function() {
			return false;
		}
		me._cardboard.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._cardboard.onclick=function (e) {
			me.player.openUrl("vr.html#"+me.ggUserdata.source,"_self");
		}
		this._cardboard.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this.divSkin.appendChild(this._cardboard);
		me._popup_video_file.ggVideoSource = 'media/';
		me._popup_video_file.ggVideoNotLoaded = true;
